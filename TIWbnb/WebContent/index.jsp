											...
											<div class="col-sm-12 mt">
												<section>
													...
													<select class="cs-select cs-skin-border">
														<option value="" disabled selected>Hasta 35â‚¬</option>
														<option value="P1">Hasta 35â‚¬</option>            
														<option value="P2">36â‚¬ - 69â‚¬</option>
														<option value="P3">70â‚¬ - 130â‚¬</option>
														<option value="P4">131â‚¬ o mÃ¡s</option>
													</select>
												</section>
											</div>
